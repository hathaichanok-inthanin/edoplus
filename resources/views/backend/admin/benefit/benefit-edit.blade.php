...
@section('content')
    <div class="container-fluid py-4">
        <div class="campaign">
            ...
            <h4 class="mt-4">แก้ไขสิทธิประโยชน์สมาชิก</h4>
            <div class="row mt-4">
                ...
                <div class="col-md-8">
                    ...
                    <form action="{{ url('update-benefit') }}" enctype="multipart/form-data" method="post">@csrf
                        <div class="row">
                                ...
                                <div class="card z-index-2">
                                    <div class="card-header pb-0 pt-3 bg-transparent">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                <p><span>*</span> รายละเอียดเงื่อนไข <span>(จำเป็นต้องกรอก)</span>
                                                ...
                                                <textarea name="detail" class="form-control" id="editor">{{ $benefit->detail }}</textarea>
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <p>สถานะ</p>
                                                <select name="status" class="form-control">
                                                    <option value="{{ $benefit->status }}">{{ $benefit->status }}
                                                    </option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <button type="submit"
                                                    class="btn btn-lg btn-success">เพิ่มสิทธิประโยชน์สมาชิก</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
