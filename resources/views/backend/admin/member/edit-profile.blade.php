                        ...
                        <form action="{{ url('editProfile') }}" enctype="multipart/form-data" method="post">@csrf
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <p>Invitation Only</p>
                                        <select name="invitation" class="form-control">
                                            <option value="{{ $member->invitation }}">{{ $member->invitation }}</option>
                                            <option value=""></option>
                                            <option value="วงเงิน 500,000">วงเงิน 500,000</option>
                                            <option value="วงเงิน 1,000,000">วงเงิน 1,000,000</option>
                                            <option value="วงเงิน 2,000,000">วงเงิน 2,000,000</option>
