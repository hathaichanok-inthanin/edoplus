                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-2">
                                                <p><span>*</span> หัวข้อบทความ <span>(จำเป็นต้องกรอก)</span>
                                                    @if ($errors->has('title'))
                                                        <center><span class="text-danger"
                                                                style="font-size: 15px;">({{ $errors->first('title') }})</span>
                                                        </center>
                                                    @endif
                                                </p>
                                            ...
                                            <div class="col-md-12 mt-2">
                                                <p><span>*</span> เนื้อหา <span>(จำเป็นต้องกรอก)</span>
                                                    @if ($errors->has('article'))
                                                        <center><span class="text-danger"
                                                                style="font-size: 15px;">({{ $errors->first('article') }})</span>
                                                        </center>
                                                    @endif
                                                </p>
                                                <textarea name="article" class="form-control" id="editor">{{ $article->article }}</textarea>
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <p>สถานะ</p>
