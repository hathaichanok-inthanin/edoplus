                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            if ($value->invitation == 'วงเงิน 500,000') {
                                                                ...
                                                                $balance = 0.10 * $balance + $balance; // members get an additional 10%
                                                                ...
                                                                $balance = 0.20 * $balance + $balance; // members get an additional 20%
                                                            }
                                                        ...
                                                        <a href="{{ url('add-balance') }}/{{ $value->id }}"><i
