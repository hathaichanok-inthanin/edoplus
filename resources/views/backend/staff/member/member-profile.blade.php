                                        ...
                                        <h5 class="mt-2">หมายเลขบัตรประชาชน <i class="fa fa-caret-down"
                                            ...
                                            <h5>
                                                @if ($member->card_id == null)
                                                    <a
                                                        href="{{ url('staff/editProfile') }}/{{ $member->id }}">ใส่หมายเลขบัตรประชาชน</a>
                                                @else
                                        ...
                                        <tbody class="list">
                                            @foreach ($balances as $balance => $value)
                                                ...
                                                <tr style="text-align:center;">
                                                    ...
                                                    <td>
                                                        @if ($value->file != null)
                                                            <a href="{{ url('staff/invitation-file-detail') }}/{{ $value->id }}"
                                                                style="color:#0c6640;">
                                        ...
                                        <tbody class="list">
                                            @foreach ($specialmember_balances as $specialmember_balance => $value)
                                                ...
                                                <tr style="text-align:center;">
                                                    ...
                                                    <td>
                                                        @if ($value->file != null)
                                                            <a href="{{ url('staff/specialmember-file-detail') }}/{{ $value->id }}"
                                                                style="color:#0c6640;">
                                                                <i class="fas fa-image" aria-hidden="true"></i>
                                                            </a>
                                                        @endif
