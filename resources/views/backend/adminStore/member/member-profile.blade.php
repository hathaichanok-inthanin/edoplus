                    ...
                    <div class="col-lg-8 mt-4 mb-lg-0 mb-4">
                        ...
                        <div class="card z-index-2">
                            <div class="card-header pb-0 pt-3 bg-transparent">
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a href="{{ url('admin/edit-profile') }}/{{ $member->id }}"><i
                                                class="ni ni-settings" aria-hidden="true"></i> แก้ไขข้อมูล</a>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <h5 class="mt-2">หมายเลขบัตรประชาชน <i class="fa fa-caret-down"
                                            ...
                                            <h5>
                                                @if ($member->card_id == null)
                                                    <a
                                                        href="{{ url('admin/edit-profile') }}/{{ $member->id }}">ใส่หมายเลขบัตรประชาชน</a>
                                                @else
                                        ...
                                        <tbody class="list">
                                            @foreach ($specialmember_balances as $specialmember_balance => $value)
                                                ...
                                                <tr style="text-align:center;">
                                                    ...
                                                    <td>
                                                        @if ($value->file != null)
                                                            <a href="{{ url('admin/specialmember-file-detail') }}/{{ $value->id }}"
                                                                style="color:#0c6640;">
                                                                <i class="fas fa-image" aria-hidden="true"></i>
                                                            </a>
                                                        @endif
